...
select TO_TIMESTAMP('2022-11-20 19:00:00','YYYY-MM-DD HH24:MI:SS'), 'Al Bayt Stadium',id,tournament_group_id from team where name = 'Qatar';
update match set away_team_id=subquery.id from (select id from team where name='Ecuador') as subquery where stadium = 'Al Bayt Stadium';

insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-21 16:00:00','YYYY-MM-DD HH24:MI:SS'), 'Khalifa International Stadium',id,tournament_group_id from team where name = 'England';
update match set away_team_id=subquery.id from (select id from team where name='Iran') as subquery where stadium = 'Khalifa International Stadium';


insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-21 16:00:00','YYYY-MM-DD HH24:MI:SS'), 'Al Janoub Stadium',id,tournament_group_id from team where name = 'France';
update match set away_team_id=subquery.id from (select id from team where name='Australia') as subquery where stadium = 'Al Janoub Stadium';

insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-22 19:00:00','YYYY-MM-DD HH24:MI:SS'), 'Stadium 974',id,tournament_group_id from team where name = 'Mexico';
update match set away_team_id=subquery.id from (select id from team where name='Poland') as subquery where stadium = 'Stadium 974';

insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-22 13:00:00','YYYY-MM-DD HH24:MI:SS'), 'Lusail Stadium',id,tournament_group_id from team where name = 'Argentina';
update match set away_team_id=subquery.id from (select id from team where name='Saudi Arabia') as subquery where stadium = 'Lusail Stadium';

insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-23 10:00:00','YYYY-MM-DD HH24:MI:SS'), 'Ahmad Bin Ali Stadium',id,tournament_group_id from team where name = 'Belgium';
update match set away_team_id=subquery.id from (select id from team where name='Canada') as subquery where stadium = 'Ahmad Bin Ali Stadium';

insert into match(start_time, stadium, home_team_id, tournament_group_id)
select TO_TIMESTAMP('2022-11-23 19:00:00','YYYY-MM-DD HH24:MI:SS'), 'Al Thumama Stadium',id,tournament_group_id from team where name = 'Spain';
update match set away_team_id=subquery.id from (select id from team where name='Costa Rica') as subquery where stadium = 'Al Thumama Stadium';
